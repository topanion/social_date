/*
timeDifference = returns an object with minutes hours and days difference
timeOrNot = function for messages in conversations, will return a bool that says whether it should display time or not
*/
